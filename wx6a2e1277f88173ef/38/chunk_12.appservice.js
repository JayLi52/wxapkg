...
__wxRoute = "components/l-ui/l-status-bar/l-status-bar";
__wxRouteBegin = true;
__wxAppCurrentFile__ = "components/l-ui/l-status-bar/l-status-bar.js";
define("components/l-ui/l-status-bar/l-status-bar.js", function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, XMLHttpRequest, WebSocket, Reporter, webkit, WeixinJSCore) {
    "use strict";
    var t = require("../../../common/vendor.js"),
        ...
        r = t._export_sfc(e, [
            ["__scopeId", "data-v-55197ef9"]
        ]);
    wx.createComponent(r);
}, {
    isPage: false,
    isComponent: true,
    currentFile: 'components/l-ui/l-status-bar/l-status-bar.js'
});
require("components/l-ui/l-status-bar/l-status-bar.js");