$gwx_XC_1 = function(_, _v, _n, _p, _s, _wp, _wl, $gwn, $gwl, $gwh, wh, $gstack, $gwrt, gra, grb, TestTest, wfor, _ca, _da, _r, _rz, _o, _oz, _1, _1z, _2, _2z, _m, _mz, nv_getDate, nv_getRegExp, nv_console, nv_parseInt, nv_parseFloat, nv_isNaN, nv_isFinite, nv_decodeURI, nv_decodeURIComponent, nv_encodeURI, nv_encodeURIComponent, $gdc, nv_JSON, _af, _gv, _ai, _grp, _gd, _gapi, $ixc, _ic, _w, _ev, _tsd) {
    return function(path, global) {
        ...
        var m0 = function(e, s, r, gg) {
            ...
            if (_oz(z, 2, e, s, gg)) {
                cUJ.wxVkey = 1
                var oVJ = _mz(z, 'work-cover', ['bind:__l', 3, 'class', 1, 'style', 2, 'uI', 3, 'uP', 4], [], e, s, gg)
                _(cUJ, oVJ)
            }
            cUJ.wxXCkey = 1
            cUJ.wxXCkey = 3
...
if (!noCss) {
    __wxAppCode__['components/avatar/index.wxss'] = setCssToHead([".", [1], "avater.", [1], "data-v-6fb3e71a{background-color:#eee;display:inline-block;-webkit-flex-shrink:0;flex-shrink:0;margin:0;padding:0}\n", ], undefined, {
        path: "./components/avatar/index.wxss"
    });
}