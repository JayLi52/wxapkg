$gwx_XC_38 = function(_, _v, _n, _p, _s, _wp, _wl, $gwn, $gwl, $gwh, wh, $gstack, $gwrt, gra, grb, TestTest, wfor, _ca, _da, _r, _rz, _o, _oz, _1, _1z, _2, _2z, _m, _mz, nv_getDate, nv_getRegExp, nv_console, nv_parseInt, nv_parseFloat, nv_isNaN, nv_isFinite, nv_decodeURI, nv_decodeURIComponent, nv_encodeURI, nv_encodeURIComponent, $gdc, nv_JSON, _af, _gv, _ai, _grp, _gd, _gapi, $ixc, _ic, _w, _ev, _tsd) {
    return function(path, global) {
        ...
        var m0 = function(e, s, r, gg) {
            ...
            if (_oz(z, 0, e, s, gg)) {
                hK5B.wxVkey = 1
                var oL5B = _mz(z, 'image', ['binderror', 1, 'bindload', 1, 'bindtap', 2, 'lazyLoad', 3, 'mode', 4, 'resize', 5, 'src', 6, 'style', 7], [], e, s, gg)
                _(hK5B, oL5B)
            } else {
                hK5B.wxVkey = 2
                var cM5B = _mz(z, 'image', ['binderror', 9, 'bindload', 1, 'bindtap', 2, 'lazyLoad', 3, 'mode', 4, 'src', 5, 'style', 6], [], e, s, gg)
                _(hK5B, cM5B)
            }
            hK5B.wxXCkey = 1
            return r
...
if (!noCss) {
    __wxAppCode__['components/cache-image/index.wxss'] = setCssToHead([], undefined, {
        path: "./components/cache-image/index.wxss"
    });
}